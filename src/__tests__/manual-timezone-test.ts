/**
 * Manual Test Script for Timezone Conversion
 * 
 * This script can be run to manually verify that:
 * 1. Date parameters are passed correctly based on system time
 * 2. PST times from API are converted to local timezone
 * 
 * To run this test:
...
(window as any).timezoneTests = {
  testDateParameterCalculation,
  testPSTToLocalConversion,
  testIntegration,
  testTimeUntilCalculation
};

console.log('🧪 Timezone Test Functions Loaded!');
console.log('Run any of these functions:');
console.log('- timezoneTests.testDateParameterCalculation()');
console.log('- timezoneTests.testPSTToLocalConversion()');
console.log('- timezoneTests.testIntegration()');
console.log('- timezoneTests.testTimeUntilCalculation()');
console.log('');
console.log('Or run the full integration test:');
console.log('timezoneTests.testIntegration()');
